...
const upcomingEvents: Event[] = [
  {
    ...
    title: 'EBCC-1 Event',
    description: 'Join us for an exciting hands-on workshop building electrical bluetooth controlled cars!',
    date: 'Apr. 25',
  ...
  },
  {
    ...
    description: 'Get involved in meaningful STEM projects that make a difference in our community.',
    date: 'Spring Fall to',
    time: '-',
...
const pastEvents = [
  {
    ...
    description: 'Learn essential skills and strategies to excel in hackathons.',
    date: '23 October',
    time: '-',
  ...
  },
  {
    ...
    description: 'Celebrating diversity and empowering women of color in STEM fields.',
    date: '29 October',
  ...
  },
  {
    ...
    title: 'Game Night',
    description: 'Join us for a fun night of gaming and networking with fellow CS enthusiasts!',
    date: '30 October',
    time: '4:00 - 7:00 PM',
  ...
  },
  {
    ...
    description: 'Insightful talk from industry expert Jim Herold about careers in tech.',
    date: '1 November',
    time: '10 AM',
    location: 'Building 61, Room 2316',
    rsvpUrl: 'https://forms.office.com/pages/responsepage.aspx?id=8ktNzJ4KQEKu3qfR1oj5NfaMcBznXHtFpUoFBwrvxcZURDZDNkdOSFlWSzRSVFVJQTFNTzY3TEJaSy4u&origin=QRCode&route=shorturl'
  },
  {
    id: '1',
    ...
    rsvpUrl: 'https://docs.google.com/forms/d/e/1FAIpQLSdlxrm0XRRa4iipwRsZ5by0ySOy65Rgiccym5OW-ndXoI-H8w/viewform'
  },
  {
    id: '7',
    imageSrc: '/static/events/mtysacuclav932.png',
    title: 'UCLA + Break Through Tech AI Program Info Session',
    description: 'Learn about exciting opportunities with UCLA and Break Through Tech AI Program.',
    date: '3 December',
  ...
  },
  {
    ...
    description: 'Connect with experienced mentors in a virtual setting to get guidance on your academic and career journey.',
    date: '13 March',
