...
const page = () => {
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <section className=" px-6 py-20 lg:px-32">
      ...
      <section className="w-full bg-[#edd7b4] px-6 py-20 lg:px-32 flex flex-col">
        <h1 className="text-start font-garamond font-thin text-5xl mb-12">
        ...
        >
          ...
          <AccordionItem value="q3" className="border-b border-black">
            <AccordionTrigger className="text-lg font-medium">Is the club open to all majors?</AccordionTrigger>
            <AccordionContent className="text-base text-gray-900">
          ...
          <AccordionItem value="q4" className="border-b border-black">
            <AccordionTrigger className="text-lg font-medium">Is there a membership fee?</AccordionTrigger>
            <AccordionContent className="text-base text-gray-900">
          ...
          <AccordionItem value="q7" className="border-b border-black">
            <AccordionTrigger className="text-lg font-medium">What if I have more questions?</AccordionTrigger>
            <AccordionContent className="text-base text-gray-900">
